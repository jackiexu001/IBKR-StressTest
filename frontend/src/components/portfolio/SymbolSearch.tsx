...
export function SymbolSearch({ onSelect, placeholder = '输入代码或名称搜索，如 AAPL, ES, 0700' }: SymbolSearchProps) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      />
      {loading && (
        <div className="absolute right-3 top-2.5 text-slate-400 text-xs">搜索中…</div>
      )}
